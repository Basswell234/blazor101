...
public class ServersRepository
{
    public static List<Server> Servers { get; set; } = new List<Server>
    {
        ...
        new Server { ServerId = 3, Name = "Server 3", IsOnline = true, City = "Chicago" },
        ...
        new Server { ServerId = 7, Name = "Server 7", IsOnline = true, City = "Denver" },
        ...
        new Server { ServerId = 10, Name = "Server 10", IsOnline = false, City = "Dallas" },
